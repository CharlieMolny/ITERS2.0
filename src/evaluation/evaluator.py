...
class Evaluator:
    ...
    def evaluate(self, model, env, feedback_size=0, path=None, seed=None, lmbda=0.2, epsilon=0, write=False):
        ...
        if write:
            self.write_csv(self.reward_dict, path, seed, lmbda, epsilon)
    ...
    def write_csv(self, rew_dict, path, seed, lmbda,epsilon):
